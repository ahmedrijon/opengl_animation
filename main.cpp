...
void zebra_crossing(){
    ...
    glColor3f(1.0,1.0,1.0);
    glBegin(GL_POLYGON);
        glVertex2f(-15.0f,5.90f);
        glVertex2f(-20.0f,5.90f);
...
drawstring(-7.0,6.0,0.0,"Press Y for traffic Yellow Light");
...
void rules_screen(void){
    ...
    glClear(GL_COLOR_BUFFER_BIT);
    glColor3f(1,0,0);
    drawstring(-10.0,15.0,0.0,"IUBAT");
...
{
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0f, 0.0f, 0.0f);/*background for cover page*/
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(0.0f, 0.0f, 0.0f);
...
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-6.50,1,0.0,"Rejoan Ahmed          ID:19103033");
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-6.50,-1,0.0,"Ariful Islam Akash    ID:19103026");
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-3.50,-3.5,0.0,"<-Enter for next->");
glFlush();
}
...
void display1(){
    ...
    glColor3f(0.7,0,1);
    drawstring(-15.0,8.90,0.0,"IUBAT");
...
int main()
{
	...
	glutCreateWindow ("Traffic Signal Controller Project");
